...
const servicetUpdateController = async (req, res) => {
  ...
  user.services[index]["serviceOne"] =
    req.body.services.Name || user["services"][index]["Name "];
  user.services[index]["serviceTwo"] =
    req.body.services.serviceTwo || user["services"][index]["serviceTwo"];
  user.services[index]["serviceThree"] =
    req.body.services.serviceThree || user["services"][index]["serviceThree"];
  user.save();
  res.json(user);
};
